...
type
  TFRepAparatosSueldos = class(TFRepGenerico)
    ...
    QRLabel10: TQRLabel;
    QRDBText6: TQRDBText;
    IBQPorcentajeParaSueldo: TIBQuery;
...
begin
  inherited;
  Value := FloatToStr((acumulado*porcentajeSueldo)*(StrToFloat(Value)/100));
end;

procedure TFRepAparatosSueldos.FormCreate(Sender: TObject);
begin
  inherited;
  IBQPorcentajeParaSueldo.Close;
  IBQPorcentajeParaSueldo.Open;
  porcentajeSueldo := (IBQPorcentajeParaSueldo.FieldByName('valor').AsInteger/100);
end;

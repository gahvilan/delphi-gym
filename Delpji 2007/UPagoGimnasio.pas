...
uses
  ...
  cxMaskEdit, cxDropDownEdit, cxCalendar, DBCtrls;
...
begin
  ...
  try
    ...
    begin
      ...
      MessageDlg('Ya se ha regiistrado el pago para la fecha '+DateToStr(DEFechaPago.Date)+' para este cliente ',mtError,[mbOk],0);

inherited FRepProfesoresAerobicos: TFRepProfesoresAerobicos
  Left = 276
  Top = 142
  Width = 699
  Height = 471
  Caption = 'FRepProfesoresAerobicos'
  OldCreateOrder = True
  OnCreate = FormCreate
  PixelsPerInch = 96
  TextHeight = 13
  ...
  object PBotones: TPanel
    ...
    object BPreview: TcxButton
      ...
      Width = 153
      Height = 25
      Caption = 'Presentaci'#242'n Preliminar'
      TabOrder = 0
  ...
  object PFiltros: TPanel
    ...
    object cxAnio: TcxTextEdit
      ...
      Width = 71
      Height = 21
      Properties.OnChange = cxAnioPropertiesChange
      TabOrder = 1
    end
  end
  object IBQGetCantidad: TIBQuery
    ...
    object IBQGetCantidadSUELDO_MENSUAL: TIBBCDField

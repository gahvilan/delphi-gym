inherited FCronograma: TFCronograma
  Left = 247
  Top = 8
  Width = 862
  Height = 698
  ...
  object PCrono: TPanel
    ...
    object PCalendario: TPlanner
      ...
      Caption.Title = ' Calendario de Actividades'
      ...
      Version = '2.2.0.4'
      OnItemSelect = PCalendarioItemSelect
      OnItemExit = PCalendarioItemExit
      Skin.SkinCaptionX = 0
      Skin.SkinCaptionY = 0
      Skin.SkinX = 0
      Skin.SkinY = 0
  ...
  object IBQInsert: TIBQuery
    ...
    SQL.Strings = (
        ...
        'insert into acargo values(:id_profe,:id_clase,:dia,:mes,:anio,:h' +
        'ora)')
    Left = 688
    Top = 81
    ParamData = <
  ...
  object IBQBuscarMes: TIBQuery
    ...
    SQL.Strings = (
        ...
        'select (select p.nombre||'#39' '#39'||p.apellido from personal p where (' +
        'a.id_personal=p.id_personal)) as Nombre, (select nombre from dis' +
        'iplinas d where (d.id_disiplina=a.id_disiplina)) as Disiplina, a' +
        '.Dia as Dia, a.Hora as Hora from acargo a where mes=:mes and ani' +
        'o=:anio')
    Left = 632
    Top = 225
    ParamData = <
  ...
  object IBQEliminarClase: TIBQuery
    Database = DMGimnasio.IBDGimnasio
    Transaction = DMGimnasio.IBTGimnasio
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
        ...
        'delete from acargo where mes=:mes and anio=:anio and hora=:hora ' +
        'and dia=:dia')
    Left = 680
    Top = 225
    ParamData = <
  ...
  object PDCalendario: TPrintDialog
    Left = 600
    Top = 608
  end
end

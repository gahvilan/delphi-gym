...
uses
  ...
  UEstadisticasPreview in 'UEstadisticasPreview.pas' {FEstadisticasPreview},
  UMensaje in 'UMensaje.pas' {FMensaje},
  UPagoCrosfit in 'UPagoCrosfit.pas' {FPagoCrossfit},
  UCajaPreview in 'UCajaPreview.pas' {FCajaPreview};

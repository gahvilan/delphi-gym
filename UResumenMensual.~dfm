inherited FResumenMensual: TFResumenMensual
  Left = 286
  Top = 137
  Caption = 'FResumenMensual'
  OldCreateOrder = True
  OnCreate = FormCreate
  PixelsPerInch = 96
  TextHeight = 13
  ...
  object DSArmarReporte: TDataSource
    DataSet = IBQArmarReporte
    Left = 448
    Top = 97
  end
  object IBQArmarReporte: TIBQuery
    ...
    object IBQArmarReporteINGRESO: TIBStringField
      FieldName = 'INGRESO'
      Origin = 'ARMAR_REPORTE_MENSUAL.INGRESO'
      Size = 101
    end
    object IBQArmarReporteDISIPLINA: TIBStringField
      FieldName = 'DISIPLINA'
      Origin = 'ARMAR_REPORTE_MENSUAL.DISIPLINA'
      Size = 50
    end
    object IBQArmarReporteSALDO: TIBBCDField
      FieldName = 'SALDO'
      Origin = 'ARMAR_REPORTE_MENSUAL.SALDO'
      Precision = 9
      Size = 3
    end
  end
